...
class CatatanAppsActivity : AppCompatActivity() {
    private lateinit var addNote: ImageButton
    private lateinit var listFileName: MutableList<ItemModel>
    private lateinit var itemNoteAdapter: NoteAdapter
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableEdgeToEdge()
        setContentView(R.layout.activity_catatan_apps)
    ...
    private fun onClickListeners() {
        addNote.setOnClickListener {
            val intent = Intent(this, TambahCatatanAct::class.java)
    ...
    private fun updateFileList() {
        ...
        itemNoteAdapter = NoteAdapter(this, listFileName) { item ->
